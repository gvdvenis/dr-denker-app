<template>
  <div class="puzzle-grid">
    <button class="crossword-fab" @click="openCrossword" :aria-label="$t('puzzleGrid.openCrossword')">
    ...
    <div class="grid-container">
      ...
      >
        <img
          ...
          :alt="$t('puzzleGrid.puzzlePiece', { index })"
          class="puzzle-image"
        />
        ...
        <div class="badge-container">
          ...
          <div v-if="likelihoods[index]" class="badge-rounded" :class="likelihoodClass(likelihoods[index].likelihood)">
...
interface Props {
  ...
  likelihoods?: Record<number, { likelihood: number; uncertainty: number }>
}
...
function likelihoodClass(val: number) {
